...
*3 商品にアダルト コンテンツが含まれている場合は必須
*4 マルチパックを作成した場合は、Google の無料リスティングで必須です。
*5 メインの商品を含む一括販売商品を作成した場合は、Google の無料リスティングで必須です。
*6 年齢層が指定されているすべての商品, ファッション・アクセサリー（ID 166）で必須です。
